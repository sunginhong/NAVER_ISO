    ...
    public void onPageScrolled(final int position, float positionOffset, int positionOffsetPixels) {
        ...
        for (int i = 0; i < MainActivity.main_vp_cardcotainArray.length; i++) {
            if (i == position) {
                ...
                Utils.ModulatetTransYAnim(MainActivity.main_vp_cardcotainArray[i], positionOffset, 0, 1, Utils.dpToPx(10), Utils.dpToPx(30));
            ...
            if (i == positionNEXT) {
                ...
                Utils.ModulatetTransYAnim(MainActivity.main_vp_cardcotainArray[i], positionOffset, 0, 1, Utils.dpToPx(30), Utils.dpToPx(10));
